...
const ProfileModal = ({ setEdit }) => {
  ...
  const handleSaveProfile = async (e) => {
    ...
    try {
        ...
        const {username,bio,location,cover_photo,profile_picture,full_name}=editForm
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <form className="space-y-4" onSubmit={(e)=>toast.promise(
            ...
            <div className="flex justify-end space-x-3 pt-6">
              ...
              <button
                type="submit"
                className="px-4 py-2  bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition cursor-pointer text-white rounded-lg"
              >
                Save Changes
              </button>
            </div>
