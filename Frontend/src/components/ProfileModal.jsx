...
const ProfileModal = ({setEdit}) => {
  ...
  return (
    ...
    <div className='fixed too-0 bottom-0 left-0 right-0 z-110 h-screen overflow-y-scroll bg-black/50 '>
            ...
            <div className='bg-white rounded-lg shadow p-6'>
                ...
                <input type="text"  className='w-full  p-3 border border-gray-200 rounded-lg' placeholder='Please enter your location' onChange={(e)=>setEditForm({...editForm,location:e.target.value})} value={editForm.location}/>
                    ...
                    <div className='flex justify-end space-x-3 pt-6'>
                        ...
                        <button type='button' onClick={()=>setEdit(false)} className='px-4 py-2 border  border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors cursor-pointer'>Cancel</button>
                        <button type='submit' className='px-4 py-2  bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:scale-95 transition cursor-pointer text-white rounded-lg'>Save Changes</button>
